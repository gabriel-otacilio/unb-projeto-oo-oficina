...
<body>
    <div class="container">
        ...
        <div class="page-header">
            ...
            <h2 class="page-title">Carros do Cliente</h2>
                    ...
                    <div class="car-item">
                        <div class="car-info">
                            ...
                            <div class="car-details">
                                <div class="car-label">Número do Chassi</div>
                                <div class="car-value">{{id_carro}}</div>
                            </div>
                        </div>
                        <form method="post" action="{{action}}" class="delete-form">
                            <input type="hidden" name="numero_chassi" value="{{id_carro}}">
                            <button type="submit" class="btn-delete" onclick="return confirm('Tem certeza que deseja excluir este carro?')">
        ...
        % else:
            ...
            <div class="no-cars">
                ...
                <h4 style="color: #7f8c8d; margin-bottom: 1rem;">Nenhum carro registrado</h4>
                <p>Este cliente ainda não possui carros cadastrados no sistema.</p>
            </div>
        % end
